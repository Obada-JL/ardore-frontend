// API Configuration
const BASE_URL =
  process.env.NEXT_PUBLIC_API_BASE_URL || "https://api.ardoreperfume.com";
...
export const API_ENDPOINTS = {
  ...
  GET_FEEDBACK: `${BASE_URL}/api/feedback`,
...
export const perfumeAPI = {
  getPerfumes: async (params = {}) => {
    ...
    const url = queryString
      ? `${API_ENDPOINTS.GET_PERFUMES}?${queryString}`
...
export const userStatsAPI = {
  ...
  getFavoritesCount: async () => {
    const response = await apiRequest(
      `${API_ENDPOINTS.BASE_URL}/api/favorites/count`
    );
...
export const favoritesAPI = {
  ...
  isFavorite: async (perfumeId) => {
    const response = await apiRequest(
      `${API_ENDPOINTS.BASE_URL}/api/favorites/check/${perfumeId}`
    );
...
export const feedbackAPI = {
  createFeedback: async (feedbackData) => {
    return apiRequest(API_ENDPOINTS.CREATE_FEEDBACK, {
      method: "POST",
  ...
  getFeedback: async () => {
    return apiRequest(API_ENDPOINTS.GET_FEEDBACK);
  },
};
